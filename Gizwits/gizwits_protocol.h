...
* @{
*/
#define PRODUCT_KEY "bd0bd45d718440bdbd2824534cd53468"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "3d38a5e8ca234cee82f55bdee7c5fcd9"
...
#define humi_LEN                           1
#define HR_RATIO                         1
#define HR_ADDITION                      0
#define HR_MIN                           0
#define HR_MAX                           100
#define HR_LEN                           1
#define Sp02_RATIO                         1
#define Sp02_ADDITION                      0
#define Sp02_MIN                           0
#define Sp02_MAX                           100
#define Sp02_LEN                           1
#define tempcontrol_RATIO                         1
#define tempcontrol_ADDITION                      0
#define tempcontrol_MIN                           0
#define tempcontrol_MAX                           100
#define tempcontrol_LEN                           1
#define latitude_RATIO                         0.01
#define latitude_ADDITION                      0
#define latitude_MIN                           0
#define latitude_MAX                           9000
#define latitude_LEN                           2
#define longitude_RATIO                         0.01
#define longitude_ADDITION                      0
#define longitude_MIN                           0
#define longitude_MAX                           18000
#define longitude_LEN                           2
#define ppm_RATIO                         0.01
#define ppm_ADDITION                      0
#define ppm_MIN                           0
#define ppm_MAX                           600000
#define ppm_LEN                           4
...
typedef struct {
    ...
    uint8_t flagHR:1;
    uint8_t flagSp02:1;
    uint8_t flagtempcontrol:1;
    uint8_t flaglatitude:1;
    uint8_t flaglongitude:1;
    uint8_t flagppm:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valueHR;
    uint8_t valueSp02;
    uint8_t valuetempcontrol;
    uint16_t valuelatitude;
    uint16_t valuelongitude;
    uint32_t valueppm;
} devStatus_t;
