...
//==============================================MAX30102硬件接口==================================================
#define		MAX30102_IIC_CLK				RCC_APB2Periph_GPIOA
#define		MAX30102_IIC_PORT				GPIOA
#define		MAX30102_IIC_SCL_PIN		GPIO_Pin_5
#define		MAX30102_IIC_SDA_PIN		GPIO_Pin_6
 
#define 	MAX30102_IIC_SCL				PAout(5)
#define 	MAX30102_IIC_SDA				PAout(6)


#define 	MAX30102_READ_SDA   		PAin(6)  //输入SDA 
